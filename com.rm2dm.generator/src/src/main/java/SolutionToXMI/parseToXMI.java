package src.main.java.SolutionToXMI;
...
import src.main.java.GA.remodelparse;
import src.main.java.GA.ReafFromReports;
...
public class parseToXMI {
    ...
    static String pattern_Refer = "([A-z]*) : ([A-z]*).*";
    public static void main(String[] args) throws IOException {
        parseToXMI.createXml("cocome.remodel");
    }
    ...
    public static Document createXml(String remnodelName) throws IOException {
        ...
        //int[] chrome = new int[]{ 2 ,0 ,0 ,0 ,1 ,0 ,3 ,3, 0, 0, 4, 4, 0, 1, 4, 4, 4, 0, 2, 0, 3, 3, 0, 2, 2 };
