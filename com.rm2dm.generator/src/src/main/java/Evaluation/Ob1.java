package src.main.java.Evaluation;
...
public class Ob1 extends AbstractObjectiveFunction {
    public Ob1() {
        this.objectiveFunctionTitle = "Functional coupling";
    }
    @Override
    public double getValue(Chromosome chromosome) {
        ...
        return -QualityCalculate.functionCoupling(divi,Edivi);
    }
}