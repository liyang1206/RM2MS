 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.OperationParametersImpl#getObject <em>Object</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.OperationParametersImpl#getObjectproperty <em>Objectproperty</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.OperationParametersImpl#getString <em>String</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationParametersImpl extends MinimalEObjectImpl.Container implements OperationParameters {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.OPERATION_PARAMETERS;
	}
	...
	public void setObject(String newObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.OPERATION_PARAMETERS__OBJECT, oldObject,
					object));
	}
	...
	public NotificationChain basicSetObjectproperty(PropertyCallExpCS newObjectproperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.OPERATION_PARAMETERS__OBJECTPROPERTY, oldObjectproperty, newObjectproperty);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newObjectproperty != objectproperty) {
			...
			if (objectproperty != null)
				msgs = ((InternalEObject) objectproperty).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.OPERATION_PARAMETERS__OBJECTPROPERTY, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.OPERATION_PARAMETERS__OBJECTPROPERTY,
	...
	public void setString(String newString) {
		...
		string = newString;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.OPERATION_PARAMETERS__STRING, oldString,
					string));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.OPERATION_PARAMETERS__OBJECTPROPERTY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReqPackage.OPERATION_PARAMETERS__OBJECT:
			return getObject();
		case ReqPackage.OPERATION_PARAMETERS__OBJECTPROPERTY:
			return getObjectproperty();
		case ReqPackage.OPERATION_PARAMETERS__STRING:
			return getString();
		}
