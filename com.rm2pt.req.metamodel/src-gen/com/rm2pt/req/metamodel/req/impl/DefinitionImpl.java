 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.DefinitionImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefinitionImpl extends MinimalEObjectImpl.Container implements Definition {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.DEFINITION;
	}
	...
	public EList<VariableDeclarationCS> getVariable() {
		if (variable == null) {
			variable = new EObjectContainmentEList<VariableDeclarationCS>(VariableDeclarationCS.class, this,
					ReqPackage.DEFINITION__VARIABLE);
		}
		return variable;
	}
