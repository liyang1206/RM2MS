 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.PropertyCallExpCSImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.PropertyCallExpCSImpl#getSelfproperty <em>Selfproperty</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.PropertyCallExpCSImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.PropertyCallExpCSImpl#getPremark <em>Premark</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyCallExpCSImpl extends FeatureCallExpCSImpl implements PropertyCallExpCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.PROPERTY_CALL_EXP_CS;
	}
	...
	public NotificationChain basicSetName(VariableExpCS newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.PROPERTY_CALL_EXP_CS__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.PROPERTY_CALL_EXP_CS__NAME, null, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.PROPERTY_CALL_EXP_CS__NAME, newName,
					newName));
	}
	...
	public NotificationChain basicSetSelfproperty(VariableExpCS newSelfproperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.PROPERTY_CALL_EXP_CS__SELFPROPERTY, oldSelfproperty, newSelfproperty);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newSelfproperty != selfproperty) {
			...
			if (selfproperty != null)
				msgs = ((InternalEObject) selfproperty).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.PROPERTY_CALL_EXP_CS__SELFPROPERTY, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.PROPERTY_CALL_EXP_CS__SELFPROPERTY,
	...
	public void setAttribute(String newAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.PROPERTY_CALL_EXP_CS__ATTRIBUTE,
	...
	public void setPremark(String newPremark) {
		...
		premark = newPremark;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.PROPERTY_CALL_EXP_CS__PREMARK, oldPremark,
					premark));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.PROPERTY_CALL_EXP_CS__NAME:
			return basicSetName(null, msgs);
		case ReqPackage.PROPERTY_CALL_EXP_CS__SELFPROPERTY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ReqPackage.PROPERTY_CALL_EXP_CS__ATTRIBUTE:
			return getAttribute();
		case ReqPackage.PROPERTY_CALL_EXP_CS__PREMARK:
			return getPremark();
		}
