 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.CollectionLiteralExpCSImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.CollectionLiteralExpCSImpl#getPart <em>Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionLiteralExpCSImpl extends LiteralExpCSImpl implements CollectionLiteralExpCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.COLLECTION_LITERAL_EXP_CS;
	}
	...
	public NotificationChain basicSetKind(CollectionTypeIdentifierCS newKind, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.COLLECTION_LITERAL_EXP_CS__KIND, oldKind, newKind);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newKind != kind) {
			...
			if (kind != null)
				msgs = ((InternalEObject) kind).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.COLLECTION_LITERAL_EXP_CS__KIND, null, msgs);
			if (newKind != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.COLLECTION_LITERAL_EXP_CS__KIND, newKind,
					newKind));
	}
	...
	public EList<CollectionLiteralPartCS> getPart() {
		if (part == null) {
			part = new EObjectContainmentEList<CollectionLiteralPartCS>(CollectionLiteralPartCS.class, this,
					ReqPackage.COLLECTION_LITERAL_EXP_CS__PART);
		}
		return part;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.COLLECTION_LITERAL_EXP_CS__KIND:
			return basicSetKind(null, msgs);
		case ReqPackage.COLLECTION_LITERAL_EXP_CS__PART:
