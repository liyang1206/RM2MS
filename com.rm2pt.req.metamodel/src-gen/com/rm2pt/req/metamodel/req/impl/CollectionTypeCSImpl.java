 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.CollectionTypeCSImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.CollectionTypeCSImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionTypeCSImpl extends TypeCSImpl implements CollectionTypeCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.COLLECTION_TYPE_CS;
	}
	...
	public NotificationChain basicSetName(CollectionTypeIdentifierCS newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.COLLECTION_TYPE_CS__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.COLLECTION_TYPE_CS__NAME, null, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.COLLECTION_TYPE_CS__NAME, newName,
					newName));
	}
	...
	public NotificationChain basicSetType(TypeCS newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.COLLECTION_TYPE_CS__TYPE, oldType, newType);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject) type).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.COLLECTION_TYPE_CS__TYPE, null, msgs);
			if (newType != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.COLLECTION_TYPE_CS__TYPE, newType,
					newType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.COLLECTION_TYPE_CS__NAME:
			return basicSetName(null, msgs);
		case ReqPackage.COLLECTION_TYPE_CS__TYPE:
