 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.AtomicExpressionImpl#getLeftside <em>Leftside</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.AtomicExpressionImpl#getInfixop <em>Infixop</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.AtomicExpressionImpl#getRightside <em>Rightside</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.AtomicExpressionImpl#getOp <em>Op</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.AtomicExpressionImpl#getNum <em>Num</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.AtomicExpressionImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AtomicExpressionImpl extends MinimalEObjectImpl.Container implements AtomicExpression {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.ATOMIC_EXPRESSION;
	}
	...
	public NotificationChain basicSetLeftside(LeftSubAtomicExpression newLeftside, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.ATOMIC_EXPRESSION__LEFTSIDE, oldLeftside, newLeftside);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeftside != leftside) {
			...
			if (leftside != null)
				msgs = ((InternalEObject) leftside).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.ATOMIC_EXPRESSION__LEFTSIDE, null, msgs);
			if (newLeftside != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ATOMIC_EXPRESSION__LEFTSIDE, newLeftside,
					newLeftside));
	}
	...
	public void setInfixop(String newInfixop) {
		...
		infixop = newInfixop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ATOMIC_EXPRESSION__INFIXOP, oldInfixop,
					infixop));
	}
	...
	public NotificationChain basicSetRightside(RightSubAtomicExpression newRightside, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.ATOMIC_EXPRESSION__RIGHTSIDE, oldRightside, newRightside);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRightside != rightside) {
			...
			if (rightside != null)
				msgs = ((InternalEObject) rightside).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.ATOMIC_EXPRESSION__RIGHTSIDE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ATOMIC_EXPRESSION__RIGHTSIDE, newRightside,
					newRightside));
	}
	...
	public void setOp(String newOp) {
		...
		op = newOp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ATOMIC_EXPRESSION__OP, oldOp, op));
	}
	...
	public NotificationChain basicSetNum(PrimitiveLiteralExpCS newNum, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.ATOMIC_EXPRESSION__NUM, oldNum, newNum);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newNum != num) {
			...
			if (num != null)
				msgs = ((InternalEObject) num).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.ATOMIC_EXPRESSION__NUM, null, msgs);
			if (newNum != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ATOMIC_EXPRESSION__NUM, newNum, newNum));
	}
	...
	public NotificationChain basicSetExp(AtomicExpression newExp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.ATOMIC_EXPRESSION__EXP, oldExp, newExp);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newExp != exp) {
			...
			if (exp != null)
				msgs = ((InternalEObject) exp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.ATOMIC_EXPRESSION__EXP, null, msgs);
			if (newExp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ATOMIC_EXPRESSION__EXP, newExp, newExp));
	}
