 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.NestedExpCSImpl#getNestedExpression <em>Nested Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NestedExpCSImpl extends OCLExpressionCSImpl implements NestedExpCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.NESTED_EXP_CS;
	}
	...
	public NotificationChain basicSetNestedExpression(OCLExpressionCS newNestedExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.NESTED_EXP_CS__NESTED_EXPRESSION, oldNestedExpression, newNestedExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newNestedExpression != nestedExpression) {
			...
			if (nestedExpression != null)
				msgs = ((InternalEObject) nestedExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.NESTED_EXP_CS__NESTED_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.NESTED_EXP_CS__NESTED_EXPRESSION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.NESTED_EXP_CS__NESTED_EXPRESSION:
