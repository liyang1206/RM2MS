 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.OperandImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.OperandImpl#getStart <em>Start</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.OperandImpl#getFinish <em>Finish</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperandImpl extends MinimalEObjectImpl.Container implements Operand {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.OPERAND;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.OPERAND__NAME, oldName, name));
	}
	...
	public OperandEnd getStart() {
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReqPackage.OPERAND__START, oldStart,
							start));
			}
		}
		return start;
	...
	public void setStart(OperandEnd newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.OPERAND__START, oldStart, start));
	}
	...
	public MixOpAndCFEnd getFinish() {
		if (finish != null && finish.eIsProxy()) {
			...
			if (finish != oldFinish) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReqPackage.OPERAND__FINISH, oldFinish,
							finish));
			}
		}
		return finish;
	...
	public void setFinish(MixOpAndCFEnd newFinish) {
		...
		finish = newFinish;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.OPERAND__FINISH, oldFinish, finish));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReqPackage.OPERAND__NAME:
			return getName();
		case ReqPackage.OPERAND__START:
			if (resolve)
				return getStart();
			return basicGetStart();
		case ReqPackage.OPERAND__FINISH:
			if (resolve)
				return getFinish();
