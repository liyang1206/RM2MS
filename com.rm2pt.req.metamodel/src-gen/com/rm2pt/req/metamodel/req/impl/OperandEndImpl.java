 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.OperandEndImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperandEndImpl extends MixOpAndCFEndImpl implements OperandEnd {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.OPERAND_END;
	}
		...
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReqPackage.OPERAND_END__OWNER, oldOwner,
							owner));
			}
		}
		return owner;
	...
	public void setOwner(Operand newOwner) {
		...
		owner = newOwner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.OPERAND_END__OWNER, oldOwner, owner));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReqPackage.OPERAND_END__OWNER:
			if (resolve)
				return getOwner();
