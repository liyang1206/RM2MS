 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.PreconditionImpl#getOclexp <em>Oclexp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PreconditionImpl extends MinimalEObjectImpl.Container implements Precondition {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.PRECONDITION;
	}
	...
	public NotificationChain basicSetOclexp(OCLExpressionCS newOclexp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.PRECONDITION__OCLEXP, oldOclexp, newOclexp);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newOclexp != oclexp) {
			...
			if (oclexp != null)
				msgs = ((InternalEObject) oclexp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.PRECONDITION__OCLEXP, null, msgs);
			if (newOclexp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.PRECONDITION__OCLEXP, newOclexp,
					newOclexp));
	}
