 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.SwitchCaseImpl#getCaseValue <em>Case Value</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.SwitchCaseImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchCaseImpl extends MinimalEObjectImpl.Container implements SwitchCase {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.SWITCH_CASE;
	}
	...
	public void setCaseValue(String newCaseValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.SWITCH_CASE__CASE_VALUE, oldCaseValue,
					caseValue));
	}
	...
	public NotificationChain basicSetOp(SimpleOperation newOp, NotificationChain msgs) {
		...
		op = newOp;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqPackage.SWITCH_CASE__OP,
					oldOp, newOp);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOp(SimpleOperation newOp) {
		if (newOp != op) {
			...
			if (op != null)
				msgs = ((InternalEObject) op).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqPackage.SWITCH_CASE__OP,
						null, msgs);
			if (newOp != null)
				msgs = ((InternalEObject) newOp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqPackage.SWITCH_CASE__OP,
						null, msgs);
			msgs = basicSetOp(newOp, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.SWITCH_CASE__OP, newOp, newOp));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.SWITCH_CASE__OP:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReqPackage.SWITCH_CASE__CASE_VALUE:
			return getCaseValue();
		case ReqPackage.SWITCH_CASE__OP:
			return getOp();
		}
