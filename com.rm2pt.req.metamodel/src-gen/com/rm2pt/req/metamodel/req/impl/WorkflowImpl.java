 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.WorkflowImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.WorkflowImpl#getParticipants <em>Participants</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.WorkflowImpl#getPartitions <em>Partitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkflowImpl extends MinimalEObjectImpl.Container implements Workflow {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.WORKFLOW;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.WORKFLOW__NAME, oldName, name));
	}
	...
	public EList<Participant> getParticipants() {
		if (participants == null) {
			participants = new EObjectResolvingEList<Participant>(Participant.class, this,
					ReqPackage.WORKFLOW__PARTICIPANTS);
		}
		return participants;
	}
	...
	public EList<Partition> getPartitions() {
		if (partitions == null) {
			partitions = new EObjectContainmentEList<Partition>(Partition.class, this, ReqPackage.WORKFLOW__PARTITIONS);
		}
		return partitions;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ReqPackage.WORKFLOW__NAME:
			return getName();
		case ReqPackage.WORKFLOW__PARTICIPANTS:
