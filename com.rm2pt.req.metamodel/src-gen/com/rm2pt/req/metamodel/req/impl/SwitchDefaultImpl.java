 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.SwitchDefaultImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwitchDefaultImpl extends MinimalEObjectImpl.Container implements SwitchDefault {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.SWITCH_DEFAULT;
	}
	...
	public NotificationChain basicSetOp(SimpleOperation newOp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.SWITCH_DEFAULT__OP, oldOp, newOp);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newOp != op) {
			...
			if (op != null)
				msgs = ((InternalEObject) op).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.SWITCH_DEFAULT__OP, null, msgs);
			if (newOp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.SWITCH_DEFAULT__OP, newOp, newOp));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.SWITCH_DEFAULT__OP:
