 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.LogicFormulaExpCSImpl#getAtomicexp <em>Atomicexp</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.LogicFormulaExpCSImpl#getConnector <em>Connector</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicFormulaExpCSImpl extends OCLExpressionCSImpl implements LogicFormulaExpCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.LOGIC_FORMULA_EXP_CS;
	}
	...
	public EList<EObject> getAtomicexp() {
		if (atomicexp == null) {
			atomicexp = new EObjectContainmentEList<EObject>(EObject.class, this,
					ReqPackage.LOGIC_FORMULA_EXP_CS__ATOMICEXP);
		}
		return atomicexp;
	}
	...
	public EList<String> getConnector() {
		if (connector == null) {
			connector = new EDataTypeEList<String>(String.class, this, ReqPackage.LOGIC_FORMULA_EXP_CS__CONNECTOR);
		}
		return connector;
	}
