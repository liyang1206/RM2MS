 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.VariableDeclarationCSImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.VariableDeclarationCSImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.VariableDeclarationCSImpl#getInitExpression <em>Init Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableDeclarationCSImpl extends MinimalEObjectImpl.Container implements VariableDeclarationCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.VARIABLE_DECLARATION_CS;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.VARIABLE_DECLARATION_CS__NAME, oldName,
					name));
	}
	...
	public NotificationChain basicSetType(TypeCS newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.VARIABLE_DECLARATION_CS__TYPE, oldType, newType);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject) type).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.VARIABLE_DECLARATION_CS__TYPE, null, msgs);
			if (newType != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.VARIABLE_DECLARATION_CS__TYPE, newType,
					newType));
	}
	...
	public NotificationChain basicSetInitExpression(OCLExpressionCS newInitExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.VARIABLE_DECLARATION_CS__INIT_EXPRESSION, oldInitExpression, newInitExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newInitExpression != initExpression) {
			...
			if (initExpression != null)
				msgs = ((InternalEObject) initExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.VARIABLE_DECLARATION_CS__INIT_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.VARIABLE_DECLARATION_CS__INIT_EXPRESSION,
