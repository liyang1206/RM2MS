 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.InvarianceImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.InvarianceImpl#getOcl <em>Ocl</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.InvarianceImpl#isIsForAssociation <em>Is For Association</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InvarianceImpl extends MinimalEObjectImpl.Container implements Invariance {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.INVARIANCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.INVARIANCE__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetOcl(OCLExpressionCS newOcl, NotificationChain msgs) {
		...
		ocl = newOcl;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReqPackage.INVARIANCE__OCL,
					oldOcl, newOcl);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOcl(OCLExpressionCS newOcl) {
		if (newOcl != ocl) {
			...
			if (ocl != null)
				msgs = ((InternalEObject) ocl).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReqPackage.INVARIANCE__OCL,
						null, msgs);
			if (newOcl != null)
				msgs = ((InternalEObject) newOcl).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReqPackage.INVARIANCE__OCL,
						null, msgs);
			msgs = basicSetOcl(newOcl, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.INVARIANCE__OCL, newOcl, newOcl));
	}
	...
	public void setIsForAssociation(boolean newIsForAssociation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.INVARIANCE__IS_FOR_ASSOCIATION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.INVARIANCE__OCL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReqPackage.INVARIANCE__NAME:
			return getName();
		case ReqPackage.INVARIANCE__OCL:
			return getOcl();
		case ReqPackage.INVARIANCE__IS_FOR_ASSOCIATION:
