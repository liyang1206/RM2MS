 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.ForkNodeImpl#getStartlinks <em>Startlinks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForkNodeImpl extends WorkflowExpImpl implements ForkNode {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.FORK_NODE;
	}
	...
	public EList<JoinExp> getStartlinks() {
		if (startlinks == null) {
			startlinks = new EObjectResolvingEList<JoinExp>(JoinExp.class, this, ReqPackage.FORK_NODE__STARTLINKS);
		}
		return startlinks;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReqPackage.FORK_NODE__STARTLINKS:
