 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.IfExpCSImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.IfExpCSImpl#getThenExpression <em>Then Expression</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.IfExpCSImpl#getElseExpression <em>Else Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfExpCSImpl extends OCLExpressionCSImpl implements IfExpCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.IF_EXP_CS;
	}
	...
	public NotificationChain basicSetCondition(OCLExpressionCS newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.IF_EXP_CS__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.IF_EXP_CS__CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.IF_EXP_CS__CONDITION, newCondition,
					newCondition));
	}
	...
	public NotificationChain basicSetThenExpression(OCLExpressionCS newThenExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.IF_EXP_CS__THEN_EXPRESSION, oldThenExpression, newThenExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newThenExpression != thenExpression) {
			...
			if (thenExpression != null)
				msgs = ((InternalEObject) thenExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.IF_EXP_CS__THEN_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.IF_EXP_CS__THEN_EXPRESSION,
	...
	public NotificationChain basicSetElseExpression(OCLExpressionCS newElseExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.IF_EXP_CS__ELSE_EXPRESSION, oldElseExpression, newElseExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newElseExpression != elseExpression) {
			...
			if (elseExpression != null)
				msgs = ((InternalEObject) elseExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.IF_EXP_CS__ELSE_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.IF_EXP_CS__ELSE_EXPRESSION,
