 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardOperationExpCSImpl#getObject <em>Object</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardOperationExpCSImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardOperationExpCSImpl#getPremark <em>Premark</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardOperationExpCSImpl#getPredefinedop <em>Predefinedop</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StandardOperationExpCSImpl extends FeatureCallExpCSImpl implements StandardOperationExpCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.STANDARD_OPERATION_EXP_CS;
	}
	...
	public NotificationChain basicSetObject(VariableExpCS newObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_OPERATION_EXP_CS__OBJECT, oldObject, newObject);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newObject != object) {
			...
			if (object != null)
				msgs = ((InternalEObject) object).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.STANDARD_OPERATION_EXP_CS__OBJECT, null, msgs);
			if (newObject != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.STANDARD_OPERATION_EXP_CS__OBJECT,
					newObject, newObject));
	}
	...
	public NotificationChain basicSetProperty(VariableExpCS newProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_OPERATION_EXP_CS__PROPERTY, oldProperty, newProperty);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newProperty != property) {
			...
			if (property != null)
				msgs = ((InternalEObject) property).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.STANDARD_OPERATION_EXP_CS__PROPERTY, null, msgs);
			if (newProperty != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.STANDARD_OPERATION_EXP_CS__PROPERTY,
	...
	public void setPremark(String newPremark) {
		...
		premark = newPremark;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.STANDARD_OPERATION_EXP_CS__PREMARK,
					oldPremark, premark));
	}
	...
	public NotificationChain basicSetPredefinedop(PredefineOp newPredefinedop, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_OPERATION_EXP_CS__PREDEFINEDOP, oldPredefinedop, newPredefinedop);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newPredefinedop != predefinedop) {
			...
			if (predefinedop != null)
				msgs = ((InternalEObject) predefinedop).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.STANDARD_OPERATION_EXP_CS__PREDEFINEDOP, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.STANDARD_OPERATION_EXP_CS__PREDEFINEDOP,
					newPredefinedop, newPredefinedop));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.STANDARD_OPERATION_EXP_CS__OBJECT:
			return basicSetObject(null, msgs);
		case ReqPackage.STANDARD_OPERATION_EXP_CS__PROPERTY:
			return basicSetProperty(null, msgs);
		case ReqPackage.STANDARD_OPERATION_EXP_CS__PREDEFINEDOP:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ReqPackage.STANDARD_OPERATION_EXP_CS__PROPERTY:
			return getProperty();
		case ReqPackage.STANDARD_OPERATION_EXP_CS__PREMARK:
			return getPremark();
		case ReqPackage.STANDARD_OPERATION_EXP_CS__PREDEFINEDOP:
