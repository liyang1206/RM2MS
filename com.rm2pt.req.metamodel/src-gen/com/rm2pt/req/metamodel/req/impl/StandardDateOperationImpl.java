 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardDateOperationImpl#getObject <em>Object</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardDateOperationImpl#getDatenum <em>Datenum</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardDateOperationImpl#getProcall <em>Procall</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardDateOperationImpl#getNested <em>Nested</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StandardDateOperationImpl extends PredefineOpImpl implements StandardDateOperation {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.STANDARD_DATE_OPERATION;
	}
	...
	public void setObject(String newObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.STANDARD_DATE_OPERATION__OBJECT, oldObject,
					object));
	}
	...
	public NotificationChain basicSetDatenum(NumberLiteralExpCS newDatenum, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_DATE_OPERATION__DATENUM, oldDatenum, newDatenum);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newDatenum != datenum) {
			...
			if (datenum != null)
				msgs = ((InternalEObject) datenum).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.STANDARD_DATE_OPERATION__DATENUM, null, msgs);
			if (newDatenum != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.STANDARD_DATE_OPERATION__DATENUM,
	...
	public NotificationChain basicSetProcall(PropertyCallExpCS newProcall, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_DATE_OPERATION__PROCALL, oldProcall, newProcall);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newProcall != procall) {
			...
			if (procall != null)
				msgs = ((InternalEObject) procall).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.STANDARD_DATE_OPERATION__PROCALL, null, msgs);
			if (newProcall != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.STANDARD_DATE_OPERATION__PROCALL,
	...
	public NotificationChain basicSetNested(StandardDateOperation newNested, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_DATE_OPERATION__NESTED, oldNested, newNested);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newNested != nested) {
			...
			if (nested != null)
				msgs = ((InternalEObject) nested).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.STANDARD_DATE_OPERATION__NESTED, null, msgs);
			if (newNested != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.STANDARD_DATE_OPERATION__NESTED, newNested,
					newNested));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.STANDARD_DATE_OPERATION__DATENUM:
			return basicSetDatenum(null, msgs);
		case ReqPackage.STANDARD_DATE_OPERATION__PROCALL:
			return basicSetProcall(null, msgs);
		case ReqPackage.STANDARD_DATE_OPERATION__NESTED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReqPackage.STANDARD_DATE_OPERATION__OBJECT:
			return getObject();
		case ReqPackage.STANDARD_DATE_OPERATION__DATENUM:
			return getDatenum();
		case ReqPackage.STANDARD_DATE_OPERATION__PROCALL:
