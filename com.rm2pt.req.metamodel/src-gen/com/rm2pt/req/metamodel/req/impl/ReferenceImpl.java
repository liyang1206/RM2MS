 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.ReferenceImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.ReferenceImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.ReferenceImpl#isIsmultiple <em>Ismultiple</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.ReferenceImpl#isIsReverseAssoication <em>Is Reverse Assoication</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.ReferenceImpl#isIsAggregation <em>Is Aggregation</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.ReferenceImpl#isIsComposition <em>Is Composition</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.ReferenceImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImpl extends MinimalEObjectImpl.Container implements Reference {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.REFERENCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.REFERENCE__NAME, oldName, name));
	}
	...
	public Entity getEntity() {
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReqPackage.REFERENCE__ENTITY, oldEntity,
							entity));
			}
		}
		return entity;
	...
	public void setEntity(Entity newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.REFERENCE__ENTITY, oldEntity, entity));
	}
	...
	public void setIsmultiple(boolean newIsmultiple) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.REFERENCE__ISMULTIPLE, oldIsmultiple,
					ismultiple));
	}
	...
	public void setIsReverseAssoication(boolean newIsReverseAssoication) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.REFERENCE__IS_REVERSE_ASSOICATION,
	...
	public void setIsAggregation(boolean newIsAggregation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.REFERENCE__IS_AGGREGATION,
	...
	public void setIsComposition(boolean newIsComposition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.REFERENCE__IS_COMPOSITION,
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.REFERENCE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReqPackage.REFERENCE__NAME:
			return getName();
		case ReqPackage.REFERENCE__ENTITY:
			if (resolve)
				return getEntity();
			return basicGetEntity();
		case ReqPackage.REFERENCE__ISMULTIPLE:
			return isIsmultiple();
		case ReqPackage.REFERENCE__IS_REVERSE_ASSOICATION:
			return isIsReverseAssoication();
		case ReqPackage.REFERENCE__IS_AGGREGATION:
			return isIsAggregation();
		case ReqPackage.REFERENCE__IS_COMPOSITION:
			return isIsComposition();
		case ReqPackage.REFERENCE__TYPE:
			return getType();
		}
