 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardNavigationCallExpCSImpl#getClassifercall <em>Classifercall</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardNavigationCallExpCSImpl#getPropertycall <em>Propertycall</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardNavigationCallExpCSImpl#getObject <em>Object</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardNavigationCallExpCSImpl#getNavop <em>Navop</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.StandardNavigationCallExpCSImpl#getStandardOP <em>Standard OP</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StandardNavigationCallExpCSImpl extends FeatureCallExpCSImpl implements StandardNavigationCallExpCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.STANDARD_NAVIGATION_CALL_EXP_CS;
	}
	...
	public NotificationChain basicSetClassifercall(ClassiferCallExpCS newClassifercall, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__CLASSIFERCALL, oldClassifercall, newClassifercall);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newClassifercall != classifercall) {
			...
			if (classifercall != null)
				msgs = ((InternalEObject) classifercall).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__CLASSIFERCALL, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__CLASSIFERCALL, newClassifercall, newClassifercall));
	}
	...
	public NotificationChain basicSetPropertycall(PropertyCallExpCS newPropertycall, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__PROPERTYCALL, oldPropertycall, newPropertycall);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newPropertycall != propertycall) {
			...
			if (propertycall != null)
				msgs = ((InternalEObject) propertycall).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__PROPERTYCALL, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__PROPERTYCALL, newPropertycall, newPropertycall));
	}
	...
	public void setObject(String newObject) {
		...
		object = newObject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__OBJECT,
					oldObject, object));
	}
	...
	public void setNavop(String newNavop) {
		...
		navop = newNavop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__NAVOP,
					oldNavop, navop));
	}
	...
	public NotificationChain basicSetStandardOP(StandardCollectionOperation newStandardOP, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__STANDARD_OP, oldStandardOP, newStandardOP);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newStandardOP != standardOP) {
			...
			if (standardOP != null)
				msgs = ((InternalEObject) standardOP).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__STANDARD_OP, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__STANDARD_OP, newStandardOP, newStandardOP));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__CLASSIFERCALL:
			return basicSetClassifercall(null, msgs);
		case ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__PROPERTYCALL:
			return basicSetPropertycall(null, msgs);
		case ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__STANDARD_OP:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__OBJECT:
			return getObject();
		case ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__NAVOP:
			return getNavop();
		case ReqPackage.STANDARD_NAVIGATION_CALL_EXP_CS__STANDARD_OP:
