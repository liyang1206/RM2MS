...
import com.rm2pt.req.metamodel.req.ActivityFinal;
import com.rm2pt.req.metamodel.req.Actor;
import com.rm2pt.req.metamodel.req.ArgumentsCS;
import com.rm2pt.req.metamodel.req.AtomicExpression;
import com.rm2pt.req.metamodel.req.Attribute;
import com.rm2pt.req.metamodel.req.BooleanLiteralExpCS;
import com.rm2pt.req.metamodel.req.CallExpCS;
import com.rm2pt.req.metamodel.req.CallMessage;
import com.rm2pt.req.metamodel.req.ClassiferCallExpCS;
import com.rm2pt.req.metamodel.req.CollectionItem;
import com.rm2pt.req.metamodel.req.CollectionLiteralExpCS;
import com.rm2pt.req.metamodel.req.CollectionLiteralPartCS;
import com.rm2pt.req.metamodel.req.CollectionRangeCS;
import com.rm2pt.req.metamodel.req.CollectionTypeCS;
import com.rm2pt.req.metamodel.req.CollectionTypeIdentifierCS;
import com.rm2pt.req.metamodel.req.CombinedFragment;
import com.rm2pt.req.metamodel.req.CombinedFragmentEnd;
import com.rm2pt.req.metamodel.req.ComplexOpeartion;
...
import com.rm2pt.req.metamodel.req.EntityAttributeName;
import com.rm2pt.req.metamodel.req.EntityContext;
import com.rm2pt.req.metamodel.req.EntityType;
import com.rm2pt.req.metamodel.req.EnumEntity;
import com.rm2pt.req.metamodel.req.EnumItem;
import com.rm2pt.req.metamodel.req.EnumLiteralExpCS;
import com.rm2pt.req.metamodel.req.Execution;
import com.rm2pt.req.metamodel.req.ExecutionEnd;
import com.rm2pt.req.metamodel.req.FeatureCallExpCS;
import com.rm2pt.req.metamodel.req.ForkNode;
import com.rm2pt.req.metamodel.req.IfExpCS;
import com.rm2pt.req.metamodel.req.InitalNode;
import com.rm2pt.req.metamodel.req.Interaction;
import com.rm2pt.req.metamodel.req.InvalidLiteralExpCS;
...
import com.rm2pt.req.metamodel.req.JoinNode;
import com.rm2pt.req.metamodel.req.LeftSubAtomicExpression;
import com.rm2pt.req.metamodel.req.LetExpCS;
import com.rm2pt.req.metamodel.req.LiteralExpCS;
import com.rm2pt.req.metamodel.req.LogicFormulaExpCS;
import com.rm2pt.req.metamodel.req.LoopExp;
import com.rm2pt.req.metamodel.req.LoopExpCS;
import com.rm2pt.req.metamodel.req.Message;
import com.rm2pt.req.metamodel.req.MessageEnd;
import com.rm2pt.req.metamodel.req.MixEnd;
import com.rm2pt.req.metamodel.req.MixOpAndCFEnd;
import com.rm2pt.req.metamodel.req.MultiEnd;
import com.rm2pt.req.metamodel.req.NestedExpCS;
import com.rm2pt.req.metamodel.req.NullLiteralExpCS;
import com.rm2pt.req.metamodel.req.NumberLiteralExpCS;
import com.rm2pt.req.metamodel.req.OCLExpressionCS;
import com.rm2pt.req.metamodel.req.OclTypeCS;
import com.rm2pt.req.metamodel.req.Operand;
import com.rm2pt.req.metamodel.req.OperandEnd;
import com.rm2pt.req.metamodel.req.Operation;
import com.rm2pt.req.metamodel.req.OperationCallExpCS;
import com.rm2pt.req.metamodel.req.OperationParameters;
import com.rm2pt.req.metamodel.req.Parameter;
...
import com.rm2pt.req.metamodel.req.PredefineOp;
import com.rm2pt.req.metamodel.req.PrimitiveLiteralExpCS;
import com.rm2pt.req.metamodel.req.PrimitiveTypeCS;
import com.rm2pt.req.metamodel.req.PropertyCallExpCS;
...
import com.rm2pt.req.metamodel.req.ReservedKeywordCS;
import com.rm2pt.req.metamodel.req.ReturnMessage;
import com.rm2pt.req.metamodel.req.RightSubAtomicExpression;
import com.rm2pt.req.metamodel.req.Service;
import com.rm2pt.req.metamodel.req.SimpleOperation;
import com.rm2pt.req.metamodel.req.StandardCollectionOperation;
import com.rm2pt.req.metamodel.req.StandardDateOperation;
import com.rm2pt.req.metamodel.req.StandardNavigationCallExpCS;
import com.rm2pt.req.metamodel.req.StandardNoneParameterOperation;
import com.rm2pt.req.metamodel.req.StandardOperationExpCS;
import com.rm2pt.req.metamodel.req.StandardParameterOperation;
import com.rm2pt.req.metamodel.req.StringLiteralExpCS;
...
import com.rm2pt.req.metamodel.req.TupleLiteralExpCS;
import com.rm2pt.req.metamodel.req.TupleTypeCS;
...
import com.rm2pt.req.metamodel.req.VariableExpCS;
...
public class ReqPackageImpl extends EPackageImpl implements ReqPackage {
	 ...
	 * @generated
	 */
	private EClass useCaseContextEClass = null;
	 ...
	 * @generated
	 */
	private EClass receiveInterfaceEClass = null;
	 ...
	 * @generated
	 */
	private EClass provideInterfaceEClass = null;
	 ...
	 * @see com.rm2pt.req.metamodel.req.ReqPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getDomainModel_Entitycontext() {
	 ...
	 * @generated
	 */
	public EReference getDomainModel_Systeminterface() {
	 ...
	 * @generated
	 */
	public EReference getUseCaseModel_Usecasecontext() {
	 ...
	 * @generated
	 */
	public EReference getUC_Nf() {
		return (EReference) ucEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUseCaseContext_Name() {
		return (EAttribute) useCaseContextEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUseCaseContext_Label() {
		return (EAttribute) useCaseContextEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getUseCaseContext_Uc() {
		return (EReference) useCaseContextEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getUseCaseContext_Entitycontext() {
		return (EReference) useCaseContextEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getUseCaseContext_Nf() {
		return (EReference) useCaseContextEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getEntityContext_Name() {
	 ...
	 * @generated
	 */
	public EAttribute getEntityContext_Label() {
	 ...
	 * @generated
	 */
	public EReference getEntityContext_Entity() {
	 ...
	 * @generated
	 */
	public EReference getEntityContext_Userinterface() {
	 ...
	 * @generated
	 */
	public EReference getEntityContext_Systeminterface() {
	 ...
	 * @generated
	 */
	public EReference getEntityContext_Usecasecontext() {
	...
	public EAttribute getSystemInterface_Name() {
		return (EAttribute) systemInterfaceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSystemInterface_Label() {
		return (EAttribute) systemInterfaceEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getSystemInterface_Reference() {
	 ...
	 * @generated
	 */
	public EReference getSystemInterface_Entitycontext() {
		return (EReference) systemInterfaceEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EClass getReceiveInterface() {
		return receiveInterfaceEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getReceiveInterface_Provideinterface() {
		return (EReference) receiveInterfaceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getProvideInterface() {
		return provideInterfaceEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getProvideInterface_Receiveinterface() {
		return (EReference) provideInterfaceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUserInterface_Label() {
	 ...
	 * @generated
	 */
	public EReference getUserInterface_Service() {
	 ...
	 * @generated
	 */
	public EReference getUserInterface_Operation() {
	 ...
	 * @generated
	 */
	public EAttribute getNF_Category() {
		return (EAttribute) nfEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getNF_Description() {
		return (EAttribute) nfEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getNF_Level() {
		return (EAttribute) nfEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getNF_Stakeholder() {
		return (EAttribute) nfEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(domainModelEClass, DOMAIN_MODEL__ENTITYCONTEXT);
		createEReference(domainModelEClass, DOMAIN_MODEL__SYSTEMINTERFACE);
		...
		createEReference(useCaseModelEClass, USE_CASE_MODEL__USECASECONTEXT);
		...
		createEReference(ucEClass, UC__NF);
		...
		useCaseContextEClass = createEClass(USE_CASE_CONTEXT);
		createEAttribute(useCaseContextEClass, USE_CASE_CONTEXT__NAME);
		createEAttribute(useCaseContextEClass, USE_CASE_CONTEXT__LABEL);
		createEReference(useCaseContextEClass, USE_CASE_CONTEXT__UC);
		createEReference(useCaseContextEClass, USE_CASE_CONTEXT__ENTITYCONTEXT);
		createEReference(useCaseContextEClass, USE_CASE_CONTEXT__NF);

		entityContextEClass = createEClass(ENTITY_CONTEXT);
		createEAttribute(entityContextEClass, ENTITY_CONTEXT__NAME);
		createEAttribute(entityContextEClass, ENTITY_CONTEXT__LABEL);
		createEReference(entityContextEClass, ENTITY_CONTEXT__ENTITY);
		createEReference(entityContextEClass, ENTITY_CONTEXT__USERINTERFACE);
		createEReference(entityContextEClass, ENTITY_CONTEXT__SYSTEMINTERFACE);
		createEReference(entityContextEClass, ENTITY_CONTEXT__USECASECONTEXT);

		systemInterfaceEClass = createEClass(SYSTEM_INTERFACE);
		createEAttribute(systemInterfaceEClass, SYSTEM_INTERFACE__NAME);
		createEAttribute(systemInterfaceEClass, SYSTEM_INTERFACE__LABEL);
		createEReference(systemInterfaceEClass, SYSTEM_INTERFACE__REFERENCE);
		createEReference(systemInterfaceEClass, SYSTEM_INTERFACE__ENTITYCONTEXT);

		receiveInterfaceEClass = createEClass(RECEIVE_INTERFACE);
		createEReference(receiveInterfaceEClass, RECEIVE_INTERFACE__PROVIDEINTERFACE);

		provideInterfaceEClass = createEClass(PROVIDE_INTERFACE);
		createEReference(provideInterfaceEClass, PROVIDE_INTERFACE__RECEIVEINTERFACE);

		userInterfaceEClass = createEClass(USER_INTERFACE);
		createEAttribute(userInterfaceEClass, USER_INTERFACE__NAME);
		createEAttribute(userInterfaceEClass, USER_INTERFACE__LABEL);
		createEReference(userInterfaceEClass, USER_INTERFACE__SERVICE);
		createEReference(userInterfaceEClass, USER_INTERFACE__OPERATION);

		nfEClass = createEClass(NF);
		createEAttribute(nfEClass, NF__CATEGORY);
		createEAttribute(nfEClass, NF__DESCRIPTION);
		createEAttribute(nfEClass, NF__LEVEL);
		createEAttribute(nfEClass, NF__STAKEHOLDER);
	}
	...
	public void initializePackageContents() {
		...
		receiveInterfaceEClass.getESuperTypes().add(this.getSystemInterface());
		provideInterfaceEClass.getESuperTypes().add(this.getSystemInterface());
		...
		initEAttribute(getDomainModel_Label(), ecorePackage.getEString(), "label", null, 0, 1, DomainModel.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDomainModel_Entitycontext(), this.getEntityContext(), null, "entitycontext", null, 0, -1,
				DomainModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDomainModel_Systeminterface(), this.getSystemInterface(), null, "systeminterface", null, 0,
				-1, DomainModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUseCaseModel_Contract(), this.getContract(), null, "contract", null, 0, -1,
				UseCaseModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUseCaseModel_Usecasecontext(), this.getUseCaseContext(), null, "usecasecontext", null, 0, -1,
				UseCaseModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(ucEClass, com.rm2pt.req.metamodel.req.UC.class, "UC", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUC_Name(), ecorePackage.getEString(), "name", null, 0, 1,
				com.rm2pt.req.metamodel.req.UC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUC_Label(), ecorePackage.getEString(), "label", null, 0, 1,
				com.rm2pt.req.metamodel.req.UC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUC_UCRelation(), ecorePackage.getEString(), "UCRelation", null, 0, 1,
				com.rm2pt.req.metamodel.req.UC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUC_Relateduc(), this.getUC(), null, "relateduc", null, 0, -1,
				com.rm2pt.req.metamodel.req.UC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUC_Ssd(), this.getInteraction(), null, "ssd", null, 0, -1,
				com.rm2pt.req.metamodel.req.UC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUC_Service(), this.getService(), null, "service", null, 0, -1,
				com.rm2pt.req.metamodel.req.UC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUC_Description(), ecorePackage.getEString(), "description", null, 0, 1,
				com.rm2pt.req.metamodel.req.UC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUC_Nf(), this.getNF(), null, "nf", null, 0, 2, com.rm2pt.req.metamodel.req.UC.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getContract_Post(), this.getPostcondition(), null, "post", null, 0, 1, Contract.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContract_Entity(), this.getEntity(), null, "entity", null, 0, 1, Contract.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(useCaseContextEClass, UseCaseContext.class, "UseCaseContext", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUseCaseContext_Name(), ecorePackage.getEString(), "name", null, 0, 1, UseCaseContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUseCaseContext_Label(), ecorePackage.getEString(), "label", null, 0, 1, UseCaseContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUseCaseContext_Uc(), this.getUC(), null, "uc", null, 0, -1, UseCaseContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUseCaseContext_Entitycontext(), this.getEntityContext(),
				this.getEntityContext_Usecasecontext(), "entitycontext", null, 0, 1, UseCaseContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUseCaseContext_Nf(), this.getNF(), null, "nf", null, 0, -1, UseCaseContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(entityContextEClass, EntityContext.class, "EntityContext", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEntityContext_Name(), ecorePackage.getEString(), "name", null, 0, 1, EntityContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEntityContext_Label(), ecorePackage.getEString(), "label", null, 0, 1, EntityContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntityContext_Entity(), this.getEntity(), null, "entity", null, 0, -1, EntityContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntityContext_Userinterface(), this.getUserInterface(), null, "userinterface", null, 0, -1,
				EntityContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntityContext_Systeminterface(), this.getSystemInterface(),
				this.getSystemInterface_Entitycontext(), "systeminterface", null, 0, -1, EntityContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntityContext_Usecasecontext(), this.getUseCaseContext(),
				this.getUseCaseContext_Entitycontext(), "usecasecontext", null, 0, 1, EntityContext.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(systemInterfaceEClass, SystemInterface.class, "SystemInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSystemInterface_Name(), ecorePackage.getEString(), "name", null, 0, 1, SystemInterface.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystemInterface_Label(), ecorePackage.getEString(), "label", null, 0, 1,
				SystemInterface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getSystemInterface_Reference(), this.getReference(), null, "reference", null, 0, 1,
				SystemInterface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystemInterface_Entitycontext(), this.getEntityContext(),
				this.getEntityContext_Systeminterface(), "entitycontext", null, 0, 1, SystemInterface.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(receiveInterfaceEClass, ReceiveInterface.class, "ReceiveInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReceiveInterface_Provideinterface(), this.getProvideInterface(),
				this.getProvideInterface_Receiveinterface(), "provideinterface", null, 0, -1, ReceiveInterface.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(provideInterfaceEClass, ProvideInterface.class, "ProvideInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProvideInterface_Receiveinterface(), this.getReceiveInterface(),
				this.getReceiveInterface_Provideinterface(), "receiveinterface", null, 0, -1, ProvideInterface.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(userInterfaceEClass, UserInterface.class, "UserInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUserInterface_Name(), ecorePackage.getEString(), "name", null, 0, 1, UserInterface.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUserInterface_Label(), ecorePackage.getEString(), "label", null, 0, 1, UserInterface.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUserInterface_Service(), this.getService(), null, "service", null, 0, 1, UserInterface.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUserInterface_Operation(), this.getOperation(), null, "operation", null, 0, -1,
				UserInterface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(nfEClass, com.rm2pt.req.metamodel.req.NF.class, "NF", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNF_Category(), ecorePackage.getEString(), "category", null, 0, 1,
				com.rm2pt.req.metamodel.req.NF.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNF_Description(), ecorePackage.getEString(), "description", null, 0, 1,
				com.rm2pt.req.metamodel.req.NF.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNF_Level(), ecorePackage.getEInt(), "level", null, 0, 1, com.rm2pt.req.metamodel.req.NF.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getNF_Stakeholder(), ecorePackage.getEString(), "stakeholder", null, 0, 1,
				com.rm2pt.req.metamodel.req.NF.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
