 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.ArgumentsCSImpl#getFirst <em>First</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.ArgumentsCSImpl#getNext <em>Next</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArgumentsCSImpl extends MinimalEObjectImpl.Container implements ArgumentsCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.ARGUMENTS_CS;
	}
	...
	public NotificationChain basicSetFirst(OCLExpressionCS newFirst, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.ARGUMENTS_CS__FIRST, oldFirst, newFirst);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newFirst != first) {
			...
			if (first != null)
				msgs = ((InternalEObject) first).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.ARGUMENTS_CS__FIRST, null, msgs);
			if (newFirst != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ARGUMENTS_CS__FIRST, newFirst, newFirst));
	}
	...
	public NotificationChain basicSetNext(ArgumentsCS newNext, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.ARGUMENTS_CS__NEXT, oldNext, newNext);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newNext != next) {
			...
			if (next != null)
				msgs = ((InternalEObject) next).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.ARGUMENTS_CS__NEXT, null, msgs);
			if (newNext != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ARGUMENTS_CS__NEXT, newNext, newNext));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ReqPackage.ARGUMENTS_CS__FIRST:
			return basicSetFirst(null, msgs);
		case ReqPackage.ARGUMENTS_CS__NEXT:
