 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.SimpleOperationImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SimpleOperationImpl extends WorkflowExpImpl implements SimpleOperation {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.SIMPLE_OPERATION;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReqPackage.SIMPLE_OPERATION__REF, oldRef,
							ref));
			}
		}
		return ref;
	...
	public void setRef(Operation newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.SIMPLE_OPERATION__REF, oldRef, ref));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReqPackage.SIMPLE_OPERATION__REF:
			if (resolve)
				return getRef();
			return basicGetRef();
		}
