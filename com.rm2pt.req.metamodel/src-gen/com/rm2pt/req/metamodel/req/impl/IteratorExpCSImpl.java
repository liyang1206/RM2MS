 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.IteratorExpCSImpl#getObjectCall <em>Object Call</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.IteratorExpCSImpl#getSimpleCall <em>Simple Call</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.IteratorExpCSImpl#getIterator <em>Iterator</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.IteratorExpCSImpl#getVaribles <em>Varibles</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.IteratorExpCSImpl#getExp <em>Exp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IteratorExpCSImpl extends LoopExpCSImpl implements IteratorExpCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.ITERATOR_EXP_CS;
	}
	...
	public NotificationChain basicSetObjectCall(FeatureCallExpCS newObjectCall, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.ITERATOR_EXP_CS__OBJECT_CALL, oldObjectCall, newObjectCall);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newObjectCall != objectCall) {
			...
			if (objectCall != null)
				msgs = ((InternalEObject) objectCall).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.ITERATOR_EXP_CS__OBJECT_CALL, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ITERATOR_EXP_CS__OBJECT_CALL,
	...
	public void setSimpleCall(String newSimpleCall) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ITERATOR_EXP_CS__SIMPLE_CALL,
	...
	public void setIterator(String newIterator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ITERATOR_EXP_CS__ITERATOR, oldIterator,
					iterator));
	}
	...
	public EList<VariableDeclarationCS> getVaribles() {
		if (varibles == null) {
			varibles = new EObjectContainmentEList<VariableDeclarationCS>(VariableDeclarationCS.class, this,
					ReqPackage.ITERATOR_EXP_CS__VARIBLES);
		}
		return varibles;
	}
	...
	public NotificationChain basicSetExp(OCLExpressionCS newExp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.ITERATOR_EXP_CS__EXP, oldExp, newExp);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newExp != exp) {
			...
			if (exp != null)
				msgs = ((InternalEObject) exp).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.ITERATOR_EXP_CS__EXP, null, msgs);
			if (newExp != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.ITERATOR_EXP_CS__EXP, newExp, newExp));
	}
