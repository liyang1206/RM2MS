 ...
 * </p>
 * <ul>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.LetExpCSImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link com.rm2pt.req.metamodel.req.impl.LetExpCSImpl#getInExpression <em>In Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LetExpCSImpl extends OCLExpressionCSImpl implements LetExpCS {
	...
	protected EClass eStaticClass() {
		return ReqPackage.Literals.LET_EXP_CS;
	}
	...
	public EList<VariableDeclarationCS> getVariable() {
		if (variable == null) {
			variable = new EObjectContainmentEList<VariableDeclarationCS>(VariableDeclarationCS.class, this,
					ReqPackage.LET_EXP_CS__VARIABLE);
		}
		return variable;
	}
	...
	public NotificationChain basicSetInExpression(OCLExpressionCS newInExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ReqPackage.LET_EXP_CS__IN_EXPRESSION, oldInExpression, newInExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newInExpression != inExpression) {
			...
			if (inExpression != null)
				msgs = ((InternalEObject) inExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ReqPackage.LET_EXP_CS__IN_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReqPackage.LET_EXP_CS__IN_EXPRESSION, newInExpression,
					newInExpression));
	}
