...
/**
 * This is the item provider adapter for a {@link com.rm2pt.req.metamodel.req.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ReqPackage.Literals.MESSAGE__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Message_sendingEnd_feature",
								"_UI_Message_type"),
						ReqPackage.Literals.MESSAGE__SENDING_END, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Message_receivingEnd_feature",
								"_UI_Message_type"),
						ReqPackage.Literals.MESSAGE__RECEIVING_END, true, false, true, null, null, null));
	}
