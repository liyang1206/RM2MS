...
/**
 * This is the item provider adapter for a {@link com.rm2pt.req.metamodel.req.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Attribute_name_feature",
								"_UI_Attribute_type"),
						ReqPackage.Literals.ATTRIBUTE__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Attribute_ismultiple_feature",
								"_UI_Attribute_type"),
						ReqPackage.Literals.ATTRIBUTE__ISMULTIPLE, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReqPackage.Literals.ATTRIBUTE__TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(ReqPackage.Literals.ATTRIBUTE__TYPE, ReqFactory.eINSTANCE.createTypeCS()));

		newChildDescriptors.add(
				createChildParameter(ReqPackage.Literals.ATTRIBUTE__TYPE, ReqFactory.eINSTANCE.createEntityType()));

		newChildDescriptors.add(
				createChildParameter(ReqPackage.Literals.ATTRIBUTE__TYPE, ReqFactory.eINSTANCE.createEnumEntity()));

		newChildDescriptors.add(createChildParameter(ReqPackage.Literals.ATTRIBUTE__TYPE,
