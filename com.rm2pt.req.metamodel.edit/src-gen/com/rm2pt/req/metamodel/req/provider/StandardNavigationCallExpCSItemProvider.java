...
/**
 * This is the item provider adapter for a {@link com.rm2pt.req.metamodel.req.StandardNavigationCallExpCS} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StandardNavigationCallExpCSItemProvider extends FeatureCallExpCSItemProvider {
	...
	protected void addObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				ReqPackage.Literals.STANDARD_NAVIGATION_CALL_EXP_CS__OBJECT, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_StandardNavigationCallExpCS_navop_feature",
								"_UI_StandardNavigationCallExpCS_type"),
						ReqPackage.Literals.STANDARD_NAVIGATION_CALL_EXP_CS__NAVOP, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReqPackage.Literals.STANDARD_NAVIGATION_CALL_EXP_CS__CLASSIFERCALL);
			childrenFeatures.add(ReqPackage.Literals.STANDARD_NAVIGATION_CALL_EXP_CS__PROPERTYCALL);
			childrenFeatures.add(ReqPackage.Literals.STANDARD_NAVIGATION_CALL_EXP_CS__STANDARD_OP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ReqPackage.Literals.STANDARD_NAVIGATION_CALL_EXP_CS__CLASSIFERCALL,
				ReqFactory.eINSTANCE.createClassiferCallExpCS()));

		newChildDescriptors.add(createChildParameter(ReqPackage.Literals.STANDARD_NAVIGATION_CALL_EXP_CS__PROPERTYCALL,
				ReqFactory.eINSTANCE.createPropertyCallExpCS()));

		newChildDescriptors.add(createChildParameter(ReqPackage.Literals.STANDARD_NAVIGATION_CALL_EXP_CS__STANDARD_OP,
